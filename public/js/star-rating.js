    ...
    Rating.prototype = {
        ...
        listen: function () {
            ...
            if(!self.disabled) {
	            ...
	            self.$rating.on("mouseout", function (e) {
	                    self.reset();
	            });
        ...
        init: function (options) {
            ...
            self.customRatingClass = !isEmpty(options.customRatingClass) ? options.customRatingClass : '';
            ...
            if (typeof self.$rating == 'undefined' && typeof self.$container == 'undefined') {
                self.$rating = $(document.createElement("div")).html('<div class="rating-stars '+ self.customRatingClass + '"></div>');
