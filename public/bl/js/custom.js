...
/*Boozology Extensions*/

(function ($) {
    $.fn.cat = function (e, t) {
        t = typeof t !== "undefined" ? t : 14;
        if (e.length > t) {
    ...
    $.fn.askforloginorsignup = function () {
    	$('#signinupModel').modal({show:true});
    };
    
    $.fn.giveWarnings = function () {
    ...
    $.fn.setresponse = function (e) {
        ...
        var t = this;
        t.Issuccess = true;
        t.ispost = typeof e.ispost !== "undefined" ? e.ispost : false;
        t.failreq = typeof e.failreq !== "undefined" ? e.failreq : false;
        t.issync = typeof e.issync !== "undefined" ? e.issync : true;
        t.retresp = typeof e.failans !== "undefined" ? e.failans : false;
        t.argdata = typeof e.argdata !== "undefined" ? e.argdata : "";
        
        if(t.issync){$.ajaxSetup({ async: false });}        
        var n;
        if (t.ispost) {
        ...
        n.done(function (n) {
            t.retresp = n[typeof e.successnode !== "undefined" ? e.successnode : "answer"]
        });
        n.fail(function (n) {
            t.Issuccess = false;
            if (t.failreq) {
                t.retresp = n[typeof e.failnode !== "undefined" ? e.failnode : "answer"]
            }
        });
        if(t.issync){ $.ajaxSetup({ async: true });}
        if (t.failreq) {
            return t;
        } else {
            return t.retresp
    ...
    $.fn.msgbox = function (c, t) {
        p = typeof t !== "undefined" ? true : false;
        $.colorbox({
            opacity: 0,
            html: c
        });
    ...
    $.fn.cboxresize=function(w,h){
    	if(typeof w !== "undefined" && typeof h !== "undefined")
    		$.colorbox.resize({innerWidth:w,innerHeight:h});
    	else
    		$.colorbox.resize();
    }
    $.fn.getdate = function (date) {
    	var d=new Date(date.replace(' ','T'));
		var ndate={date:d.getDate()+'-'+(d.getMonth() + 1)+'-'+d.getFullYear(),
							 time:d.getHours()+':'+d.getMinutes()+':'+d.getSeconds()}
		return ndate;
    };
    $.fn.shortnumber = function (number) {
        return number;
    };
}(jQuery));
