    ...
    koObject.bindingHandlers.popover = {
        init: function(element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (popoverBindingValues.title) {
                ...
                tmpOptions.template = '<div class="popover" role="tooltip"><div class=""></div><div class="popover-content"></div></div>';
            }
            ...
            $element.on(eventType, function(e) {
                ...
                $oldPopovers.each(function () {
                    ...
                    if($.contains($this.parents(".isotope-item")[0],$(popoverTriggerEl)[0])){
