...
public class Account extends Controller {
	...
	public static class PasswordChange {
		...
		public String validate() {
			if (password == null || !password.equals(repeatPassword)) {
				return Messages
						.get("boozology.change_password.error.passwords_not_same");
			}
			return null;
		}
	}
	...
	public static Result doChangePassword() {
		...
		if (filledForm.hasErrors()) {
			...
			user.changePassword(new MyUsernamePasswordAuthUser(newPassword),
					true);
			//flash(Application.FLASH_MESSAGE_KEY,	Messages.get("boozology.change_password.success"));
			//return redirect(routes.Application.profile());
	...
	public static Result doLink() {
		...
		if (filledForm.hasErrors()) {
			...
			if (link) {
				flash(Application.FLASH_MESSAGE_KEY,
						Messages.get("boozology.accounts.link.success"));
			}
	...
	public static Result doMerge() {
		...
		if (filledForm.hasErrors()) {
			...
			if (merge) {
				flash(Application.FLASH_MESSAGE_KEY,
						Messages.get("boozology.accounts.merge.success"));
			}
